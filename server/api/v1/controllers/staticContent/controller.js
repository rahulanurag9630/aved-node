...
export class staticController {
  ...
  *     summary: Add Static Content (with Arabic fields)
  *     produces:
  *       - application/json
  *     parameters:
  *       - name: authtoken
  ...
  *         required: false
  *       - name: question
  *         description: Question for FAQs in English
  *         in: formData
  *         required: false
  *       - name: question_ar
  *         description: Question for FAQs in Arabic
  *         in: formData
  *         required: false
  *       - name: answer
  *         description: Answer for FAQs in English
  *         in: formData
  *         required: false
  *       - name: answer_ar
  *         description: Answer for FAQs in Arabic
  *         in: formData
  *         required: false
  *       - name: imageUrl
  ...
  *     tags:
  *       - STATIC CONTENT
  *     description: admin updateStaticContent =====>>>>> where contentType enum:['privacyPolicy', 'termsCondition', 'aboutUs', 'faq', 'banner', 'conversationStarter', 'gettingStarted']
  *     summary: Update Static Content (with Arabic fields)
  *     produces:
  *       - application/json
  *     parameters:
  *       - name: token
